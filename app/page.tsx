    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(rgba(196,154,60,0.5) 1px, transparent 1px), linear-gradient(90deg, rgba(196,154,60,0.5) 1px, transparent 1px)",
            backgroundSize: "80px 80px",
          }}
        />
        {/* Radial glow */}
        <div className="absolute top-1/3 right-1/4 w-96 h-96 rounded-full bg-gold/4 blur-[100px] pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto px-6 pt-32 pb-20 w-full">
          <div className="max-w-3xl animate-fade-up">
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-[0.65rem] tracking-[0.25em] uppercase text-gold font-medium">
                Independent Research · Africa
              </span>
            </div>
          ...
          {/* Stats strip */}
          <div className="mt-20 pt-10 border-t border-white/6 grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { num: "47+", label: "Countries Monitored" },
              { num: "1.2M+", label: "Posts Analyzed" },
              { num: "84", label: "Research Publications" },
              { num: "6", label: "Languages Tracked" },
            ].map((stat) => (
              <div key={stat.label}>
