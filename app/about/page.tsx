      ...
      <section className="py-24 border-b border-white/5">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="space-y-0">
            {focusDetails.map((area, i) => (
              <div
                key={area.id}
                className={`grid grid-cols-1 md:grid-cols-5 gap-0 border-t border-white/6 ${
                  i === focusDetails.length - 1 ? "border-b" : ""
                }`}
              >
                {/* Number */}
                <div className="md:col-span-1 py-10 pr-8">
                  <span className="font-display text-4xl text-gold/20 font-medium">
                    {area.id}
                  </span>
                </div>
                ...
                <div className="md:col-span-2 py-10 pr-8">
                  <h3 className="font-display text-2xl text-sand font-medium mb-4">
                    {area.title}
                  </h3>
                ...
                <div className="md:col-span-2 py-10">
                  <p className="text-[0.65rem] tracking-[0.18em] uppercase text-gold/70 font-medium mb-4">
                    Capabilities
                  </p>
